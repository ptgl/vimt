...
function initialize() {
    ...
    var latlng = new google.maps.LatLng(12.214205, 109.210045);
    var myOptions = {
        zoom: 16,
        scrollwheel: false,
        center: latlng,
...
function showContactMap() {
    ...
    if ($j("#map_canvas").length > 0) {
        initialize();
        codeAddress('38b Trần Phú, TP.Nha Trang, Tỉnh Khánh Hòa');
    }
}

var no_ajax_pages = [];
var root = 'http://demo.qodeinteractive.com/central/';
